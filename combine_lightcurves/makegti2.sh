...
do
	...
	then
		...
		saextrct $INPUT gtiorfile="APPLY" gtiandfile=$p/gtifile outroot=$p/128lc_$OUTPUT accumulate="ONE" timecol="TIME" columns="GOOD" binsz=0.0078125 printmode="LIGHTCURVE" lcmode="RATE" spmode="SUM" timemin="INDEF" timemax="INDEF" timeint="INDEF" chmin="INDEF" chmax="INDEF" chint="INDEF" chbin="INDEF"
